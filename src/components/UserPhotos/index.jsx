...
import { Typography, Grid, Card, CardMedia, CardContent, Button, Divider, Box, List, Paper } from "@mui/material";
  ...
  return (
    ...
    <Box sx={{maxWidth: 1200, mx: "auto", mt: 4, px: 2}}>
      <Box sx={{display: "flex", justifyContent: "space-between", alignItems:"center", mb: 3}}>
        ...
        <Button component={Link} to={`/users/${userId}`} variant="outlined" color="primary">Back to Profile</Button>
      </Box>
      ...
      <Grid container spacing={2}>
        {photos.map((photo) => (
          <Grid item xs={12} sm={6} md={4} key={photo._id}>
            <Card>
              <CardMedia component="img" image={`http://localhost:8081/images/${photo.file_name}`} alt={`Photo by ${user.first_name} ${user.last_name}`} sx={{width: '100%', height: "auto"}}/>
              <CardContent>
